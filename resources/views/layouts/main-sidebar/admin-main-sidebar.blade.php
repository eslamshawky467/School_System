            ...
            <div class="sidebar-menu">
                <ul>
                    ...
                    <li class="sidebar-dropdown">
                        ...
                        <div class="sidebar-submenu">
                            <ul>
                                <li> <a href="{{route('online_classes.index')}}">اضافة حصة جديدة </a> </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="sidebar-dropdown">
                        ...
                        <div class="sidebar-submenu">
                            <ul>
                                <li>
                                    <a href="{{route('Students.create')}}">اضافة طالب جديد</a>
                                </li>
                                <li>
                                    <a href="{{route('Students.index')}}">عرض جميع الطلاب</a>
                                </li>
                                <li>
                                    <a href="{{route('Promotion.index')}}">ترقية الطلاب</a>
                                </li>
                                <li>
                                <li> <a href="{{route('Promotion.create')}}">الترقيات</a> </li>
                                </li>
                                <li> <a href="{{route('Graduated.create')}}">الخريجين</a></li>
                                <li><a href="{{route('Graduated.index')}}">قائمة الخريجين </a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="sidebar-dropdown">

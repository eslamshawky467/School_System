...
class ManagestudentController extends Controller
{
    ...
    public function index()
    {
        ...
        $student=Student::whereIn('section_id',$section)->get();
        return view('pages.Teachers.students',compact('student'));
    }
    ...
    public function sections(){
        ...
        return view('pages.Teachers.sections',compact('sections'));
    }
    ...
    public function attendancereport(){
        ...
        $ids = DB::table('teacher_section')->where('teacher_id', auth()->user()->id)->pluck('section_id');
        $students = Student::whereIn('section_id', $ids)->get();
        return view('pages.Teachers.attendancereport', compact('students'));
    ...
    public function attendanceSearch(Request $request){
        ...
        if($request->student_id == 0){
            ...
            return view('pages.Teachers.attendancereport',compact('Students','students'));
        }
